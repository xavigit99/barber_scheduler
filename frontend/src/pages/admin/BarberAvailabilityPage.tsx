...
export default function BarberAvailabilityPage() {
  ...
  return (
    <div>
      <div className="mb-2">
        <Link to="/admin/barbers" className="text-sm text-emerald-600 hover:underline">
          &larr; Voltar aos Barbeiros
        </Link>
      </div>
        ...
        <Table
          columns={[
            ...
            { key: 'end', header: 'Fim', render: (w) => w.end_time },
            {
              ...
              header: '',
              render: (w) => (
                <Button size="sm" variant="danger" onClick={() => handleDeleteWindow(w.id)}>
                  Remover
                </Button>
              ),
            },
        ...
        <Table
          columns={[
            ...
            { key: 'motivo', header: 'Motivo', render: (b) => b.reason ?? '-' },
            {
              ...
              header: '',
              render: (b) => (
                <Button size="sm" variant="danger" onClick={() => handleDeleteBlock(b.id)}>
                  Remover
                </Button>
              ),
            },
